    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="200">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-JNE">JNE</li>
              <li data-filter=".filter-JNT">JNT</li>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="400">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-{{$packet->ekspedisis[0]['name']}}">
            <div class="portfolio-wrap">
              <img src="{{$packet->image}}" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>{{$packet->packet_name}}</h4>
